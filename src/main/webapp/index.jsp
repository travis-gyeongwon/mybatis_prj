...
<title>JSP템플릿</title>
<link rel="shortcut icon" href="http://192.168.10.74/mybatis_prj/common/images/favicon.ico">

<script src="http://192.168.10.74/mybatis_prj/common/js/color-modes.js"></script>
<!-- bootstrap CDN 시작 -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>

<meta name="theme-color" content="#712cf9">
<link href="http://192.168.10.74/mybatis_prj/common/css/carousel.css" rel="stylesheet">
<c:import url="http://192.168.10.74/mybatis_prj/fragments/bootstrap_css.jsp"/>
<style type="text/css">
...
<body>
   ...
   <c:import url="http://192.168.10.74/mybatis_prj/fragments/header.jsp"/>
   </header>
   <main>
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         UrlVO[] urlArr={
        		...
        		new UrlVO("작다의 조희","day1226/lessThan"),	 
      ...
      <c:import url="http://192.168.10.74/mybatis_prj/fragments/footer.jsp"/>
      </footer>
   </main>
